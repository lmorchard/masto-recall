...
import ServerWebsocketsPlugin from "./websockets.js";
...
export default class ServerPlugin extends BasePlugin {
  ...
  constructor(parent) {
    ...
    this.websockets = new ServerWebsocketsPlugin(parent);
  ...
  async buildServer() {
    ...
    if (this.parent.logging.usePrettyLogs) {
    ...
    server
      ...
      .register(async (server) => websockets.extendServer(server))
    ...
    await routes.extendServer(server);
