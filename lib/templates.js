...
export default class TemplatesPlugin extends BasePlugin {
  ...
  constructor(parent) {
    ...
    handlebars.registerHelper({
      ...HandlebarHelpers(),
      "shortDateTime": this.helperShortDateTime.bind(this),
      "randomchoices": this.helperRandomChoices.bind(this),
      "choice": this.helperChoice.bind(this),
      "coalesce": (...args) => args.find((i) => !!i),
    });
  }
